...
inline constexpr std::string_view NoMatchingOperator = "as-err-no-matching-operator";
...
inline constexpr std::string_view RepeatedConversion = "as-hint-repeated-conversion";
...
inline constexpr std::string_view HandleComparisonEquality = "as-warn-handle-comparison-equality";
