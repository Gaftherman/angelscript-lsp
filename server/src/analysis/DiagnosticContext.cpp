...
namespace angel_lsp::analysis
{
    ...
    void DiagnosticContext::EmitWithRelated(uint32_t startLine, uint32_t startCharacter, uint32_t endLine, uint32_t endCharacter, std::string_view code, std::string_view arg1, const DiagnosticRelatedInformation &related, DiagnosticSeverity severity) const
    {
        Diagnostic diag;
        diag.range.start.line = startLine;
        diag.range.start.character = startCharacter;
