...
namespace angel_lsp::analysis
{
    ...
    struct DiagnosticContext
    {
        ...
        void EmitWithRelated(uint32_t startLine, uint32_t startCharacter, uint32_t endLine, uint32_t endCharacter, std::string_view code, std::string_view arg1, std::string_view arg2, std::string_view arg3, std::string_view arg4, const DiagnosticRelatedInformation &related, DiagnosticSeverity severity = DiagnosticSeverity::Error) const;
