 ...
 */
const LocalDefinition* ResolveInScope(const Scope* scope, std::string_view name, const Scope** owner = nullptr,
...
class ScopeIndex
{
  public:
     ...
     */
    template <typename Fn> void ForEachScopeTree(Fn&& callback) const
    {
