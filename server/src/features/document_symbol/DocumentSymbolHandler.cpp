...
std::vector<lsp::DocumentSymbol> ProcessChildren(TSNode containerNode, const std::string& sourceCode,
                                                 bool isInsideClass, std::string_view enclosingClassName);
 ...
 */
void ProcessNode(TSNode node, const std::string& sourceCode, bool isInsideClass, std::string_view enclosingClassName,
