...
void PopulateEnglishMessages1(MessageMap& m_messages)
{
    ...
    m_messages["as-err-template-class-not-supported"] =
        "Template/generic class definition ('{}') is only allowed in predefined files.";
    ...
    m_messages["as-err-declaration-missing-body"] =
        "'{}' must have a body '{{}}'. Only 'external shared' declares one without.";
    ...
    m_messages["as-err-funcdef-not-handle"] =
        "Variables or parameters of funcdef type '{}' must be declared as handles ('{}@').";
    ...
    m_messages["as-hint-accessor-disabled"] = "Type '{}' reaches '{}' through a script property accessor, and this "
                                              "host disables those (asEP_PROPERTY_ACCESSOR_MODE 0 or 1). The compiler "
                                              "will not accept it; call the get_ or set_ function directly.";
...
void PopulateEnglishMessages2(MessageMap& m_messages)
{
    ...
    m_messages["as-err-directive-space-after-hash"] =
        "A directive name has to follow '#' with nothing between them. '# {}' is read as a stray '#' and the compiler "
        "rejects the line; '#{}' compiles.";
    m_messages["as-err-include-not-quoted"] =
        "An #include path has to be in double quotes. Without them CScriptBuilder reads no filename, leaves the line "
        "in the source, and the compiler rejects it.";
    ...
    m_messages["as-err-interface-impl-missing"] =
        "Class '{}' does not implement interface method '{}' from interface '{}'.";
    ...
    m_messages["as-err-override-no-base"] =
        "Method '{}' marked as override but class '{}' does not replace any base class or interface method.";
    m_messages["as-err-default-param-order"] =
        "All subsequent parameters after the first default value must also have default values in function '{}'.";
    ...
    m_messages["as-err-global-variable-access-modifier"] =
        "Global or namespace variable '{}' cannot have access modifiers (private/protected).";
    m_messages["as-err-enum-scope-required"] =
        "'{}' needs its enum's scope on this host, which builds its engine with asEP_REQUIRE_ENUM_SCOPE.";
    m_messages["as-err-global-vars-disallowed"] =
        "Global variable '{}' is not allowed: global variables have been disabled by the application.";
...
void PopulateEnglishMessages3(MessageMap& m_messages)
{
    ...
    m_messages["as-err-enum-invalid-initializer"] =
        "Enum member initializer '{}' must be a constant integer expression.";
    ...
    m_messages["as-err-delete-with-other-qualifier"] =
        "Cannot flag function '{}' that will be deleted with other qualifiers.";
    m_messages["as-err-delete-not-auto-generated"] =
        "Cannot flag function '{}' that will not be auto generated as deleted. Only a default constructor, a copy "
        "constructor or 'opAssign' may be deleted.";
    ...
    m_messages["as-err-protected-member-access"] =
        ...
        "derived class, and only through an object of that class's own type.";
    m_messages["as-err-member-not-found"] = "Class '{}' has no member '{}'.";
    m_messages["as-err-virtual-property-signature"] =
        "Invalid signature for virtual property '{}'. A 'get_' accessor returns a value and takes at most an index; a "
        "'set_' accessor returns void and takes the value, optionally preceded by an index.";
...
void PopulateEnglishMessages4(MessageMap& m_messages)
{
    ...
    m_messages["as-err-mixin-virtual-property"] =
        "The virtual property syntax is currently not supported for mixin classes";
    ...
    m_messages["as-err-mixin-instantiation-member-not-found"] =
        "In mixin '{}' instantiated for '{}': Member '{}' is not declared in '{}' or its base classes.";
...
void PopulateEnglishMessages5(MessageMap& m_messages)
{
    ...
    m_messages["as-err-abstract-instantiated"] =
        "Abstract class '{}' cannot be instantiated. Declare a handle ('{}@') instead.";
    m_messages["as-err-interface-instantiated"] =
        "Interface '{}' cannot be instantiated. Declare a handle ('{}@') instead.";
    m_messages["as-err-parameter-not-instantiable"] =
        "Parameter type can't be '{}', because the type cannot be instantiated.";
    ...
    m_messages["as-warn-float-truncation"] =
        "Float value truncated in implicit conversion to integer: '{}' becomes '{}'. The fractional part is discarded.";
    m_messages["as-err-null-non-handle"] = "Cannot assign 'null' to non-handle type '{}'.";
    m_messages["as-err-no-implicit-conversion"] = "Cannot implicitly convert '{}' to '{}'. Declare a matching "
                                                  "constructor, an 'opImplConv' or an 'opAssign' overload.";
    m_messages["as-err-no-explicit-conversion"] =
        "No conversion from '{}' to '{}' exists. Declare a matching constructor on the target, or an "
        "'opConv'/'opImplConv' overload on the source.";
    m_messages["as-err-invalid-cast"] =
        "Cannot cast '{}' to '{}'. The types are unrelated and no 'opCast'/'opImplCast' overload is declared.";
    m_messages["as-warn-uninitialized-variable-read"] = "Local variable '{}' is used before it is initialized.";
    m_messages["as-err-call-no-matching-signature"] = "No matching signatures to call '{}'.";
    m_messages["as-err-constructor-not-callable"] =
        "'{}' is a constructor of '{}' and cannot be called on an instance.";
    ...
    m_messages["as-hint-list-pattern-unknown"] =
        "No list pattern is declared for '{}', so the contents of this list are not checked. Add a /// @listpattern "
        "tag above its declaration in your .as.predefined, copied from the type's asBEHAVE_LIST_FACTORY registration - "
        "for example {{repeat T}}.";
    m_messages["as-hint-accessor-portability"] =
        "Accessor for property '{}' has no `property` keyword. It is a property under asEP_PROPERTY_ACCESSOR_MODE 2 "
        "but not under mode 3, the engine's own default. Adding the keyword is accepted under both.";
...
void PopulateEnglishMessages6(MessageMap& m_messages)
{
    ...
    m_messages["as-err-multiline-string"] =
        "A plain \"...\" string may not span lines. The engine rejects it unless the host sets "
        "asEP_ALLOW_MULTILINE_STRINGS; use a \"\"\"heredoc\"\"\", which spans lines under any setting.";
    m_messages["as-err-value-assign-for-ref"] =
        "Value assignment on the reference type '{}' is not allowed: the host built its engine with "
        "asEP_DISALLOW_VALUE_ASSIGN_FOR_REF_TYPE. Use a handle assignment, `@a = @b`.";
    m_messages["as-err-named-argument-syntax"] =
        "Named argument '{}' must be written with a colon - `name: value` - not with `=`. The `=` spelling is only "
        "accepted when the host sets asEP_ALTER_SYNTAX_NAMED_ARGS.";
    m_messages["as-hint-integer-division"] =
        "Both operands are integers, so this is integer division and truncates: 1 / 2 is 0, not 0.5. It becomes float "
        "division only if the host sets asEP_DISABLE_INTEGER_DIVISION.";
    m_messages["as-err-character-literal-is-string"] =
        "A 'x' literal is a one-character string, not a character code, unless the host sets "
        "asEP_USE_CHARACTER_LITERALS - so it cannot initialise '{}'. Use a numeric literal, or set "
        "angelscript.engine.useCharacterLiterals to 1 if your host does.";
    m_messages["as-err-empty-list-element"] =
        "Empty list element is not allowed: the host built its engine with asEP_DISALLOW_EMPTY_LIST_ELEMENTS.";
    ...
    m_messages["as-hint-import-unknown-module"] =
        "No module named '{}' is configured. The compiler accepts this either way - an imported function is bound at "
        "run time - but the name matches none of the modules in angelscript.modules.";
    m_messages["as-hint-file-in-several-modules"] =
        "This file is in module '{}'. It is also inside {}, and a file is assigned to exactly one module here - the "
        "most specific claim wins: an entry point, then the deepest folder.";
    ...
    m_messages["as-err-ref-type-bool-conv-disallowed"] =
        "Implicit boolean conversion on handle/reference type is disallowed. Compare explicitly with 'null' or call "
        "'opImplConv()' directly.";
...
void PopulateEnglishMessages7(MessageMap& m_messages)
{
    ...
    m_messages["as-err-property-type-mismatch"] =
        "Getter and setter for property '{}' have mismatched types ('{}' vs '{}').";
    ...
    m_messages["as-err-compound-assign-on-value-prop"] =
        "Compound assignment is not allowed on virtual property '{}' of value type.";
    m_messages["as-err-compound-assign-on-indexed-prop"] =
        "Compound assignment is not allowed on indexed property '{}'.";
    ...
    m_messages["as-err-standalone-anonymous-function"] =
        "An anonymous function is an expression and cannot be used as a stand-alone statement. Pass it where a funcdef "
