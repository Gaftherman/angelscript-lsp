...
void Server::RegisterTextDocumentHandlers()
{
    ...
    m_messageHandler->add<lsp::requests::TextDocument_Hover>(
        [this](lsp::requests::TextDocument_Hover::Params&& req) -> lsp::requests::TextDocument_Hover::Result
        {
            ...
            LogInfo(fmt::format("[Hover Roundtrip] Total: {:.2f} ms for {} at {}:{}", roundtripMs, doc->uri,
                                req.position.line, req.position.character));
    ...
    m_messageHandler->add<lsp::requests::TextDocument_SignatureHelp>(
            ...
            -> lsp::requests::TextDocument_SignatureHelp::Result
        {
            ...
            features::SignatureHelpRequest sr{
                ...
                m_symbolTable, m_scopeIndex, codec::Decode(*doc->text, m_positionEncoding, req.position)};
    ...
    m_messageHandler->add<lsp::requests::TextDocument_DocumentLink>(
        [this](
            lsp::requests::TextDocument_DocumentLink::Params&& req) -> lsp::requests::TextDocument_DocumentLink::Result
        {
