...
void Server::RegisterWorkspaceHandlers()
{
    ...
    m_messageHandler->add<lsp::requests::Shutdown>([this]() { return this->HandleRequestsShutdown(); });

    m_messageHandler->add<lsp::notifications::Exit>([this]() { this->HandleNotificationsExit(); });
    ...
    m_messageHandler->add("angelscript/virtualDocumentContent", [this](lsp::json::Value&& params) -> lsp::json::Value
