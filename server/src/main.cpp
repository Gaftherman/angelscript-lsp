...
/**
 * @note Explicit Win32 system headers are included to guarantee standard stream binding rules 
 * on execution startup, preventing carriage-return translation issues in JSON-RPC framing.
 */
#ifdef _WIN32
#include <fcntl.h>
#include <io.h>
