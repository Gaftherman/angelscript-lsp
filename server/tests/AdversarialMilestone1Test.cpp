...
std::vector<Diagnostic> AnalyzeCodeForDiagnostics(const std::string& code,
                                                  const std::string& fileUri = "file:///adv_assign.as")
{
    AngelScriptParser parser;
    SymbolCollector collector(nullptr);
    LocalScopeCollector scopes(nullptr);
...
ParameterInformation MakeParam(std::string typeName, std::string name, bool isHandle = false, bool isConst = false,
...
TEST_SUITE("Adversarial_ExpressionTypeResolver")
{
    ...
    {
        std::string cyclicCode = "class Node\n"
                                 "{\n"
        ...
        std::string pingPongCode = "class B;\n"
                                   "class A\n"
                                   "{\n"
                                   "    B@ toB() { return null; }\n"
                                   "}\n"
    ...
    TEST_CASE("Deeply Nested Generic Template Indexing")
    {
        ...
        std::string dictMapCode = "void main()\n"
                                  "{\n"
    ...
    {
        std::string shadowCode = "void main()\n"
                                 "{\n"
                                 "    int x = 10;\n"
                                 "    {\n"
                                 "        float x = 2.5f;\n"
...
TEST_SUITE("Adversarial_OverloadResolver")
{
    ...
    TEST_CASE("Tie and Identical Scores Trigger Ambiguity Flag")
    {
        ...
        sigA.parameters = {MakeParam("int", "a"), MakeParam("double", "b")};
        symA.signature = sigA;
        ...
        sigB.parameters = {MakeParam("double", "a"), MakeParam("int", "b")};
        symB.signature = sigB;
...
TEST_SUITE("Adversarial_DefiniteAssignment")
{
    ...
    {
        std::string uninitTernary = "void Print(int v) { }\n"
                                    "void main()\n"
                                    "{\n"
                                    "    int x;\n"
                                    "    bool cond = true;\n"
        ...
        std::string uninitTernaryAlt = "void Print(int v) { }\n"
                                       "void main()\n"
                                       "{\n"
                                       "    int x;\n"
                                       "    bool cond = true;\n"
    ...
    {
        std::string binaryRead = "void main()\n"
                                 "{\n"
                                 "    int x;\n"
                                 "    bool b = (x > 5) && true;\n"
                                 "}\n";
        ...
        std::string compoundAssignRead = "void main()\n"
                                         "{\n"
                                         "    int x;\n"
                                         "    x += 5;\n"
                                         "}\n";
    ...
    TEST_CASE("Complex Control Flow With Returns In Nested Branches")
    {
        ...
        std::string nestedReturnAssigned = "void Print(int v) { }\n"
                                           "void main()\n"
                                           "{\n"
                                           "    int x;\n"
                                           "    bool a = true;\n"
        ...
        std::string nestedReturnUnassigned = "void Print(int v) { }\n"
                                             "void main()\n"
                                             "{\n"
                                             "    int x;\n"
                                             "    bool a = true;\n"
    ...
    {
        std::string unreachableCode = "void Print(int v) { }\n"
                                      "void main()\n"
                                      "{\n"
                                      "    int x;\n"
                                      "    return;\n"
    ...
    {
        std::string forLoopAssign = "void Print(int v) { }\n"
                                    "void main()\n"
                                    "{\n"
                                    "    int x;\n"
                                    "    for (int i = 0; i < 10; ++i)\n"
    ...
    {
        std::string doWhileAssign = "void Print(int v) { }\n"
                                    "void main()\n"
                                    "{\n"
                                    "    int x;\n"
                                    "    do {\n"
    ...
    {
        std::string ifElseChain = "void Print(int v) { }\n"
                                  "void main()\n"
                                  "{\n"
                                  "    int x;\n"
                                  "    int mode = 2;\n"
    ...
    {
        std::string lambdaUninit = "void main()\n"
                                   "{\n"
                                   "    auto fn = function() {\n"
                                   "        int x;\n"
                                   "        return x + 1;\n"
