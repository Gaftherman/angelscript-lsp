...
struct TokenFixture
{
    ...
    explicit TokenFixture(std::string source) : code(std::move(source))
    {
...
TEST_CASE("Semantic tokens - a field read inside a method is a property, not a namespace")
{
    ...
    TokenFixture fixture("class MyClass : AnotherClass\n"
                         "{\n"
                         "    float f;\n"
                         "\n"
                         "    void MyMethod()\n"
...
{
    TokenFixture fixture("class MyClass\n"
                         "{\n"
                         "    float f;\n"
                         "}\n");
...
{
    TokenFixture fixture("void Main()\n"
                         "{\n"
                         "    int count = 0;\n"
                         "    count = 1;\n"
                         "}\n");
...
{
    TokenFixture fixture("int g_ammo = 0;\n"
                         "void Main()\n"
                         "{\n"
                         "    g_ammo = 1;\n"
                         "}\n");
...
{
    TokenFixture fixture("void Main(int amount)\n"
                         "{\n"
                         "    amount = 2;\n"
                         "}\n");
...
{
    TokenFixture fixture("void Helper() {}\n"
                         "void Main()\n"
                         "{\n"
                         "    Helper();\n"
                         "}\n");
...
{
    TokenFixture fixture("namespace Weapons\n"
                         "{\n"
                         "    void Fire() {}\n"
                         "}\n");
...
{
    TokenFixture fixture("enum MyEnum { Value }\n"
                         "void Main()\n"
                         "{\n"
                         "    int v = MyEnum::Value;\n"
                         "}\n");
...
TEST_CASE("Semantic tokens - preprocessor lines do not produce blanket macro tokens")
{
    ...
    TokenFixture fixture("#include \"test\"\n"
                         "#if SERVER_BUILD\n"
